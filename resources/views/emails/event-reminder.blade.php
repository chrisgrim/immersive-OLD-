    ...
    <div>
        <div style="max-width: 550px;margin: auto;padding: 0rem 1rem;">
            ...
            <div style="text-align: center;margin-bottom: 1.4rem;">
                <span style="font-family: 'Sen', sans-serif;color: #6d6d6d;"><p>{{$attributes['event']}} is so close to going live on EI.</p></span>
            </div>
        </div>
        <div style="
            background: #1abdb6;
            ...
            <div style="text-align: center;max-width: 550px;margin: auto;padding: 0rem 1rem;">
                <span style="font-family: 'Sen', sans-serif;color: white;"><p style="white-space: pre-line;">Submit your event and get it listed for all of our users to find.</p></span>
            </div>
        </div>
        <div style="text-align: center;max-width: 550px;margin: auto;padding: 2rem 1rem;">
            <a href="https://everythingimmersive.com/create-event/edit">
                <button style="border: 1px solid #1abdb6;padding: .5rem 1rem;font-size: 1rem;color:#0c8a84;">Finish it up now.</button>
            </a>
        </div>
            </div>
        </div>
