    ...
    <div>
        <div style="max-width: 550px;margin: auto;padding: 0rem 1rem;">
            ...
            <div style="text-align: center;margin-bottom: 1.4rem;">
                <span style="font-family: 'Sen', sans-serif;color: #6d6d6d;"><p>Your event {{$eventname}} on Everything Immersive has been reviewed by a moderator and has some changes. Please see below and resubmit.</p></span>
            </div>
        </div>
        <div style="
            background: #1abdb6;
