...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    selectCategoryType: function selectCategoryType() {
      if (this.event.hasLocation) {
        return this.categoryOptions = this.categories.filter(function (category) {
          return category.remote == 0;
        });
      } else {
        return this.categoryOptions = this.categories.filter(function (category) {
          return category.remote == 1;
        });
      }
    }
  },
