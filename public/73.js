...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    searchEvents: function searchEvents() {
      this.type == 'category' ? window.location.href = "/index/search-online?category=".concat(this.searchBoxInput.name) : '';
      this.type == 'remote' ? window.location.href = "/index/search-online?remote=".concat(this.searchBoxInput.name) : '';
      this.type == 'tag' ? window.location.href = "/index/search-online?tag=".concat(this.searchBoxInput.name) : '';
      this.type == 'organizer' ? window.location.href = "/organizer/".concat(this.searchBoxInput.slug) : '';
      this.type == 'event' ? window.location.href = "/events/".concat(this.searchBoxInput.slug) : '';
