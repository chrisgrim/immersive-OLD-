          ...
          [
            _c(
              "tab",
              {
                ...
                attrs: { title: "Messages", notification: "true", active: true }
              },
                      ...
                      conversation.messages.length
                        ? _c(
                            ...
                            [
                              ...
                              _c(
                                "div",
                                _vm._l(conversation.messages, function(
                                  message,
                                  index
                                ) {
                                  return index == 0
            ...
            _c(
              ...
              {
                staticClass: "tab-events",
                attrs: { title: "Events", notification: "true" }
              },
              _vm._l(_vm.conversations, function(conversation) {
                return _vm.conversations
                  ? _c("div", [
                                ...
                                _c("div", { staticClass: "message-image" }, [
                                  _c("img", {
                                    attrs: {
                                      src:
                                        "/storage/" +
                                        conversation.modmessages[0].event
                                          .thumbImagePath
                                    }
                                  })
                                ]),
                                    ...
                                    ? _c("div", { staticClass: "message" }, [
                                        _c("div", [
                                          ...
                                          _c(
                                            ...
                                            [_vm._v(_vm._s(message.comments))]
                                          )
                                        ])
                                      ])
                                    : _vm._e()
