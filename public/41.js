...
/* harmony import */ var _organizers_contact_organizer_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../organizers/contact-organizer.vue */ "./resources/js/pages/organizers/contact-organizer.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    ContactOrganizer: _organizers_contact_organizer_vue__WEBPACK_IMPORTED_MODULE_3__["default"],
  ...
  methods: {
    ...
    onSubmit: function onSubmit() {
      this.disabled = true;
      axios.get("/create-event/".concat(this.event.slug, "/submit"));
      window.location.href = "/create-event/".concat(this.event.slug, "/thankyou");
    },
          ...
          _c(
            ...
            [
              ...
              _c("li", [
                _c("p", [
                  _vm._v(
                    "Audience Roll: " + _vm._s(_vm.event.advisories.audience)
                  )
                ])
              ])
            ],
            ...
            _c(
              ...
              [
                _vm._l(_vm.event.remotelocations, function(location) {
                  return _c("div", [
                    _c("h3", [_vm._v(_vm._s(location.location))]),
                    _vm._v(" "),
