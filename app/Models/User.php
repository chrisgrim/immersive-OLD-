...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','largeImagePath','thumbImagePath','provider','provider_id', 'gravatar', 'type', 'email_verified_at', 'newsletter_type', 'silence', 'unread', 'reminder'
    ];
     ...
     */
    protected $appends = [
        'profile_photo_url','hasCreatedOrganizers', 'needsApproval', 'needsOrgApproval','hasMessages', 'hexColor'
    ];
